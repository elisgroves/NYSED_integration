...
BEDS_correction <- read.csv("nyc_BEDScode_correction.csv")
...
gather_col <- c("pk12_total", "k12_total", "pk", "kg", "grade_1", "grade_2", "grade_3", "grade_4","grade_5", "grade_6",
...
#update sch.race with the correct names



############################################################
##Fix years and naming conventions for the rest of the DFs##
############################################################
###sch.total###
###############

sch.total$year[sch.total$year == "1976-77"] <- "1977"
sch.total$year[sch.total$year == "1977-78"] <- "1978"
sch.total$year[sch.total$year == "1978-79"] <- "1979"
sch.total$year[sch.total$year == "1979-80"] <- "1980"
sch.total$year[sch.total$year == "1980-81"] <- "1981"
sch.total$year[sch.total$year == "1981-82"] <- "1982"
sch.total$year[sch.total$year == "1982-83"] <- "1983"
sch.total$year[sch.total$year == "1983-84"] <- "1984"
sch.total$year[sch.total$year == "1984-85"] <- "1985"
sch.total$year[sch.total$year == "1985-86"] <- "1986"
sch.total$year[sch.total$year == "1986-87"] <- "1987"
sch.total$year[sch.total$year == "1987-88"] <- "1988"
sch.total$year[sch.total$year == "1988-89"] <- "1989"
sch.total$year[sch.total$year == "1989-90"] <- "1990"
sch.total$year[sch.total$year == "1990-91"] <- "1991"
sch.total$year[sch.total$year == "1991-92"] <- "1992"
sch.total$year[sch.total$year == "1992-93"] <- "1993"
sch.total$year[sch.total$year == "1993-94"] <- "1994"
sch.total$year[sch.total$year == "1994-1995"] <- "1995"
sch.total$year[sch.total$year == "1995-1996"] <- "1996"
sch.total$year[sch.total$year == "1996-1997"] <- "1997"
sch.total$year[sch.total$year == "1997-1998"] <- "1998"
sch.total$year[sch.total$year == "1998-1999"] <- "1999"
sch.total$year[sch.total$year == "1999-2000"] <- "2000"
sch.total$year[sch.total$year == "2000-2001"] <- "2001"
sch.total$year[sch.total$year == "2001-2002"] <- "2002"
sch.total$year[sch.total$year == "2002-2003"] <- "2003"
sch.total$year[sch.total$year == "2003-2004"] <- "2004"
sch.total$year[sch.total$year == "2004-2005"] <- "2005"
sch.total$year[sch.total$year == "2005-2006"] <- "2006"
sch.total$year[sch.total$year == "2006-2007"] <- "2007"
sch.total$year[sch.total$year == "2007-2008"] <- "2008"
sch.total$year[sch.total$year == "2008-2009"] <- "2009"
sch.total$year[sch.total$year == "2009-2010"] <- "2010"
sch.total$year[sch.total$year == "2010-2011"] <- "2011"
sch.total$year[sch.total$year == "2011-12"] <- "2012"
sch.total$year[sch.total$year == "2012-13"] <- "2013"
sch.total$year[sch.total$year == "2013-14"] <- "2014"
sch.total$year[sch.total$year == "2014-15"] <- "2015"
sch.total$year[sch.total$year == "2015-16"] <- "2016"
sch.total$year[sch.total$year == "2016-17"] <- "2017"
sch.total$year[sch.total$year == "2017-18"] <- "2018"
sch.total$year[sch.total$year == "2018-19"] <- "2019"
